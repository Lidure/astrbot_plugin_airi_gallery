...
def test_release_version_is_2_11_5_everywhere():
    ...
    assert metadata["version"] == "v2.11.5"
    assert badge == "v2.11.5"
    assert changelog == "v2.11.5"
    assert 'CURRENT_PLUGIN_VERSION = "v2.11.5"' in main_source
