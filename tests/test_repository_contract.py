...
def test_release_version_is_2_11_9_everywhere():
    ...
    assert metadata["version"] == "v2.11.9"
    assert badge == "v2.11.9"
    assert changelog == "v2.11.9"
    assert 'CURRENT_PLUGIN_VERSION = "v2.11.9"' in main_source
