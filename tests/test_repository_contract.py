...
def test_release_version_is_2_11_6_everywhere():
    ...
    assert metadata["version"] == "v2.11.6"
    assert badge == "v2.11.6"
    assert changelog == "v2.11.6"
    assert 'CURRENT_PLUGIN_VERSION = "v2.11.6"' in main_source
