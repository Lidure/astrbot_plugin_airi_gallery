...
function corsHeadersFor(origin) {
  ...
  return {
    ...
    'Access-Control-Expose-Headers': 'Retry-After, X-RateLimit-Remaining, X-RateLimit-Reset, X-Gallery-Proxy-Mode',
...
export default {
  async fetch(request, env) {
    ...
    if (blobTarget) {
      if (request.method === 'OPTIONS') return preflightResponse(request, blobTarget);
      return proxyGitHubBlob(request, blobTarget);
    }
