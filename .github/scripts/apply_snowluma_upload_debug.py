...
return_new = '''        deduplicated = deduplicate_upload_candidates_by_content(results)\n        logger.info(\n            \"[AiriGallery DEBUG upload] collector \"\n            f\"raw_candidates={len(results)} deduplicated_candidates={len(deduplicated)}\"\n        )\n        return deduplicated\n'''
